...
docker run --rm -d --name node02 -e BIFROST_P2P_KNOWN_PEERS=$IP_CONTAINER:9085 -p 9087:9085 -p 9086:9084 -p 9092:9091 -v (pwd)/node02:/staking:rw ghcr.io/stratalab/strata-node:0.0.0-8200-7a9041ed --  --config  /staking/config.yaml --regtest
